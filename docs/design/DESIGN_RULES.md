...
This file landed on its own, as docs, on 2026-09-23; CLAUDE.md points here. As of DS-2 (2026-09-24), CLAUDE.md's Inbox paragraph (Features §2/3, "The page") and its "Provenance viewer" paragraph describe D as it ships, and as of DS-3c (2026-09-24), its Clusters, Feed and Sources paragraphs; every other page paragraph keeps describing what ships until that page's DS track lands. That track updates each paragraph in the same PR that changes the code.
