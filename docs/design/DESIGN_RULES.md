...
This file landed on its own, as docs, on 2026-09-23; CLAUDE.md points here. As of DS-3a (2026-09-24), CLAUDE.md's Inbox paragraph (Features §2/3, "The page"), its Graph Explorer and entity-card paragraphs (Features §1) and its "Provenance viewer" paragraph describe D as it ships; every other page paragraph keeps describing what ships until that page's DS track lands. That track updates each paragraph in the same PR that changes the code.
