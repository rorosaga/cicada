...
The queue there, in order: **G122** (engine/model picker) → **G117** (first-run onboarding) →
**G126** (Integrations page) → **G118 slice 2** (the provenance viewer) → **G93** (cross-stream
ask). G129 slice 2 (bookmark deletions) and G125 (the study desk) are off the front of this list —
both shipped. Then the bigger rocks: **G81 → G95**, **G112 steps 2–4**, **G76**, and **G127** as a
