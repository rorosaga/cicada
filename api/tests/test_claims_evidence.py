...
def test_evidence_kinds_are_the_g118_four_then_speaker_then_media():
    # R-N2 / R-LS7: a meeting utterance by someone else is its own kind (G134);
    # G140 Q-R9 appends `media` (a video's own words). The tuple is append-only.
