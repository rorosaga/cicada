...
and Upload buttons, because a cycle starts from the Sleep page's one Consolidate control (G125 R10)
or the menu-bar bookworm, and a one-shot import lives behind the Feed's `+` (the G126 rule above).
